...
| [Cloud Certificate Manager](./pkg/ccm/)     | Store and manage third-party certificates without the complexity of network deployment settings.                                                                         |
...
| [Domain Ownership Manager](./pkg/domainownership/)     | Prove ownership of new domains you onboard to Akamai before activating your property configuration.                                                                         |
