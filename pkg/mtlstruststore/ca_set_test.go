...
func TestCloneCASet(t *testing.T) {
  ...
  "description":"New CA Set"
    ...
    "caSetStatus": "NOT_DELETED",
    "createdBy": "user1",
    "createdDate": "2025-04-10T07:03:32.987904735Z",
    "deletedBy": null,
    "deletedDate": null,
    "description": "New CA Set",
    "latestVersion": 1,
    ...
    "versionsLink": "/mtls-edge-truststore/v2/ca-sets/2/versions/"
			...
			expectedResponse: &CloneCASetResponse{
				...
				CASetStatus:       "NOT_DELETED",
				CreatedBy:         "user1",
				CreatedDate:       test.NewTimeFromString(t, "2025-04-10T07:03:32.987904735Z"),
				Description:       "New CA Set",
...
func TestGetCASetDeletionStatus(t *testing.T) {
    ...
    "endTime": null,
    "estimatedEndTime": "2025-04-15T12:25:02.183Z",
    "failureReason": null,
