...
func TestAppSec_GetThreatIntel(t *testing.T) {
	...
	tests := map[string]struct {
		...
		responseBody     string
		expectedPath     string
		expectedResponse *GetThreatIntelResponse
		withError        error
	}{
		"200 OK": {
			params: GetThreatIntelRequest{
...
func TestAppSec_UpdateThreatIntel(t *testing.T) {
	...
	tests := map[string]struct {
		...
		responseBody     string
		expectedPath     string
		expectedResponse *UpdateThreatIntelResponse
		withError        error
		headers          http.Header
	}{
		"200 Success": {
