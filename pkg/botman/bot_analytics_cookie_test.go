...
// Test Get BotAnalyticsCookie
func TestBotman_GetBotAnalyticsCookie(t *testing.T) {
	tests := map[string]struct {
		params           GetBotAnalyticsCookieRequest
		responseStatus   int
		responseBody     string
		expectedPath     string
		...
		"200 OK": {
			...
			expectedPath:     "/appsec/v1/configs/43253/versions/15/advanced-settings/bot-analytics-cookie",
...
// Test Update BotAnalyticsCookie.
func TestBotman_UpdateBotAnalyticsCookie(t *testing.T) {
	tests := map[string]struct {
		params           UpdateBotAnalyticsCookieRequest
		responseStatus   int
		responseBody     string
		expectedPath     string
		expectedResponse map[string]interface{}
