...
// Test Get CustomDenyAction List
func TestBotman_GetCustomDenyActionList(t *testing.T) {

	tests := map[string]struct {
		params           GetCustomDenyActionListRequest
		responseStatus   int
		responseBody     string
		expectedPath     string
		expectedResponse *GetCustomDenyActionListResponse
			...
			responseBody: `
{
	"customDenyActions": [
		...
		{"actionId":"4d64d85a-a07f-485a-bbac-24c60658a1b8", "testKey":"testValue5"}
			...
			expectedPath: "/appsec/v1/configs/43253/versions/15/response-actions/custom-deny-actions",
			expectedResponse: &GetCustomDenyActionListResponse{
...
// Test Get CustomDenyAction
func TestBotman_GetCustomDenyAction(t *testing.T) {
	tests := map[string]struct {
		params           GetCustomDenyActionRequest
		responseStatus   int
		responseBody     string
		expectedPath     string
		...
		"200 OK": {
			...
			expectedPath:     "/appsec/v1/configs/43253/versions/15/response-actions/custom-deny-actions/cc9c3f89-e179-4892-89cf-d5e623ba9dc7",
...
// Test Create CustomDenyAction
func TestBotman_CreateCustomDenyAction(t *testing.T) {

	tests := map[string]struct {
		params           CreateCustomDenyActionRequest
		prop             *CreateCustomDenyActionRequest
		responseStatus   int
		responseBody     string
		expectedPath     string
		expectedResponse map[string]interface{}
...
// Test Update CustomDenyAction
func TestBotman_UpdateCustomDenyAction(t *testing.T) {
	tests := map[string]struct {
		params           UpdateCustomDenyActionRequest
		responseStatus   int
		responseBody     string
		expectedPath     string
		expectedResponse map[string]interface{}
		...
		"200 Success": {
			...
			responseBody:     `{"actionId":"cc9c3f89-e179-4892-89cf-d5e623ba9dc7", "testKey":"testValue3"}`,
			expectedResponse: map[string]interface{}{"actionId": "cc9c3f89-e179-4892-89cf-d5e623ba9dc7", "testKey": "testValue3"},
			expectedPath:     "/appsec/v1/configs/43253/versions/10/response-actions/custom-deny-actions/cc9c3f89-e179-4892-89cf-d5e623ba9dc7",
		},
		"500 internal server error": {
			params: UpdateCustomDenyActionRequest{
				ConfigID:    43253,
...
// Test Remove CustomDenyAction
func TestBotman_RemoveCustomDenyAction(t *testing.T) {
	tests := map[string]struct {
		params           RemoveCustomDenyActionRequest
		responseStatus   int
		responseBody     string
		expectedPath     string
		expectedResponse map[string]interface{}
