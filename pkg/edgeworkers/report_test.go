			...
			responseBody: `
{
    ...
    "authzRealm": "abcdefgh123ij4kl.mnopqr5stu6vwxyz",
    "method": "GET",
    "serverIp": "104.81.220.111",
    "clientIp": "89.64.55.111",
    "requestId": "a73affa111",
							...
							ResponseProvider: &ResponseProvider{
								{
									...
									EdgeWorkerVersion: "10.18",
									Invocations:       1,
									Status:            ptr.To("unimplementedEventHandler"),
								},
								{
									StartDateTime:     "2022-01-10T06:00:00Z",
									EdgeWorkerVersion: "10.18",
	...
	"data": [
		...
		"200 OK - get report without data": {
			params: GetReportRequest{
				...
				EdgeWorker:   "37017",
				Status:       ptr.To(StatusSuccess),
				EventHandler: ptr.To(EventHandlerOnClientRequest),
			},
			responseStatus: http.StatusOK,
